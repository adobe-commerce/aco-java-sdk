...
/**
 * Category information for organizing products with hierarchical structure and localization
 * support.
 */
...
public class FeedCategory {
     ...
     * enhanced product organization and filtering.
     *
     * @return families
     */
    @javax.annotation.Nullable
    ...
    public FeedCategory position(Integer position) {
    ...
    public boolean equals(Object o) {
        ...
        FeedCategory feedCategory = (FeedCategory) o;
     ...
     * @throws IOException if the JSON Element is invalid with respect to FeedCategory
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FeedCategory.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in FeedCategory is not found in the empty JSON string",
                                FeedCategory.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!FeedCategory.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `FeedCategory` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : FeedCategory.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FeedCategory.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'FeedCategory' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<FeedCategory> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(FeedCategory.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<FeedCategory>() {
                        @Override
                        public void write(JsonWriter out, FeedCategory value) throws IOException {
                            JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                            elementAdapter.write(out, obj);
                        }

                        @Override
                        public FeedCategory read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of FeedCategory given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of FeedCategory
     * @throws IOException if the JSON string is invalid with respect to FeedCategory
     */
    public static FeedCategory fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, FeedCategory.class);
    }

    /**
     * Convert an instance of FeedCategory to an JSON string
     *
     * @return JSON string
     */
