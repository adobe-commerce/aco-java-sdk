...
public class FeedProductDelete {
  ...
  **/
  ...
  public FeedProductDelete scope(Scope scope) {
    this.scope = scope;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sku, feedProductDelete.sku) &&
        Objects.equals(this.scope, feedProductDelete.scope);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sku, scope);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FeedProductDelete.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FeedProductDelete is not found in the empty JSON string", FeedProductDelete.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FeedProductDelete.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FeedProductDelete` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FeedProductDelete>() {
           @Override
           public void write(JsonWriter out, FeedProductDelete value) throws IOException {
