...
public class FeedProductMetadataUpdate {
    ...
    public FeedProductMetadataUpdate() {}

    public FeedProductMetadataUpdate code(String code) {
        this.code = code;
        return this;
    }
    ...
    public FeedProductMetadataUpdate source(Source source) {
        this.source = source;
        return this;
    }
    ...
    public FeedProductMetadataUpdate visibleIn(List<VisibleInEnum> visibleIn) {
        this.visibleIn = visibleIn;
        return this;
    }

    public FeedProductMetadataUpdate addVisibleInItem(VisibleInEnum visibleInItem) {
    ...
    public FeedProductMetadataUpdate label(String label) {
        this.label = label;
        return this;
    }
    ...
    public FeedProductMetadataUpdate dataType(DataTypeEnum dataType) {
    ...
    public FeedProductMetadataUpdate filterable(Boolean filterable) {
    ...
    public FeedProductMetadataUpdate sortable(Boolean sortable) {
    ...
    public FeedProductMetadataUpdate searchable(Boolean searchable) {
    ...
    public FeedProductMetadataUpdate searchWeight(java.math.BigDecimal searchWeight) {
    ...
    public FeedProductMetadataUpdate searchTypes(List<SearchTypesEnum> searchTypes) {
        this.searchTypes = searchTypes;
        return this;
    }

    public FeedProductMetadataUpdate addSearchTypesItem(SearchTypesEnum searchTypesItem) {
    ...
    public boolean equals(Object o) {
        ...
        FeedProductMetadataUpdate feedProductMetadataUpdate = (FeedProductMetadataUpdate) o;
        return Objects.equals(this.code, feedProductMetadataUpdate.code)
                && Objects.equals(this.source, feedProductMetadataUpdate.source)
                && Objects.equals(this.visibleIn, feedProductMetadataUpdate.visibleIn)
                && Objects.equals(this.label, feedProductMetadataUpdate.label)
                && Objects.equals(this.dataType, feedProductMetadataUpdate.dataType)
                && Objects.equals(this.filterable, feedProductMetadataUpdate.filterable)
                && Objects.equals(this.sortable, feedProductMetadataUpdate.sortable)
                && Objects.equals(this.searchable, feedProductMetadataUpdate.searchable)
                && Objects.equals(this.searchWeight, feedProductMetadataUpdate.searchWeight)
                && Objects.equals(this.searchTypes, feedProductMetadataUpdate.searchTypes);
    }
    ...
    public String toString() {
        ...
        sb.append("class FeedProductMetadataUpdate {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to FeedProductMetadataUpdate
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FeedProductMetadataUpdate.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in FeedProductMetadataUpdate is not found in the empty JSON string",
                                FeedProductMetadataUpdate.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!FeedProductMetadataUpdate.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `FeedProductMetadataUpdate` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : FeedProductMetadataUpdate.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FeedProductMetadataUpdate.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'FeedProductMetadataUpdate' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<FeedProductMetadataUpdate> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(FeedProductMetadataUpdate.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<FeedProductMetadataUpdate>() {
                        @Override
                        public void write(JsonWriter out, FeedProductMetadataUpdate value)
                                throws IOException {
                        ...
                        @Override
                        public FeedProductMetadataUpdate read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of FeedProductMetadataUpdate given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of FeedProductMetadataUpdate
     * @throws IOException if the JSON string is invalid with respect to FeedProductMetadataUpdate
     */
    public static FeedProductMetadataUpdate fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, FeedProductMetadataUpdate.class);
    }

    /**
     * Convert an instance of FeedProductMetadataUpdate to an JSON string
     *
     * @return JSON string
     */
