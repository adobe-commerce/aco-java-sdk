...
public class FeedProduct {
  ...
  public enum VisibleInEnum {
    ...
    public static class Adapter extends TypeAdapter<VisibleInEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final VisibleInEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }
  ...
  **/
  ...
  public FeedProduct scope(Scope scope) {
    this.scope = scope;
    return this;
  }
  ...
  **/
  ...
  public FeedProduct status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public FeedProduct visibleIn(List<VisibleInEnum> visibleIn) {
    this.visibleIn = visibleIn;
    return this;
  }

  public FeedProduct addVisibleInItem(VisibleInEnum visibleInItem) {
  ...
  **/
  ...
  public FeedProduct metaTags(List<ProductMetaAttribute> metaTags) {
    this.metaTags = metaTags;
    return this;
  }

  public FeedProduct addMetaTagsItem(ProductMetaAttribute metaTagsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FeedProduct feedProduct = (FeedProduct) o;
    return Objects.equals(this.sku, feedProduct.sku) &&
        Objects.equals(this.scope, feedProduct.scope) &&
        Objects.equals(this.name, feedProduct.name) &&
        Objects.equals(this.slug, feedProduct.slug) &&
        Objects.equals(this.description, feedProduct.description) &&
        Objects.equals(this.shortDescription, feedProduct.shortDescription) &&
        Objects.equals(this.status, feedProduct.status) &&
        Objects.equals(this.visibleIn, feedProduct.visibleIn) &&
        Objects.equals(this.metaTags, feedProduct.metaTags) &&
        Objects.equals(this.attributes, feedProduct.attributes) &&
        Objects.equals(this.images, feedProduct.images) &&
        Objects.equals(this.links, feedProduct.links) &&
        Objects.equals(this.routes, feedProduct.routes) &&
        Objects.equals(this.configurations, feedProduct.configurations) &&
        Objects.equals(this.bundles, feedProduct.bundles);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sku, scope, name, slug, description, shortDescription, status, visibleIn, metaTags, attributes, images, links, routes, configurations, bundles);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FeedProduct {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to FeedProduct
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FeedProduct.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FeedProduct is not found in the empty JSON string", FeedProduct.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FeedProduct.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FeedProduct` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FeedProduct.openapiRequiredFields) {
      ...
      if (jsonObj.get("visibleIn") != null && !jsonObj.get("visibleIn").isJsonNull() && !jsonObj.get("visibleIn").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `visibleIn` to be an array in the JSON string but got `%s`", jsonObj.get("visibleIn").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FeedProduct.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FeedProduct' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FeedProduct> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FeedProduct.class));

       return (TypeAdapter<T>) new TypeAdapter<FeedProduct>() {
           @Override
           public void write(JsonWriter out, FeedProduct value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FeedProduct read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FeedProduct given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FeedProduct
  * @throws IOException if the JSON string is invalid with respect to FeedProduct
  */
  public static FeedProduct fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FeedProduct.class);
  }

 /**
  * Convert an instance of FeedProduct to an JSON string
  *
  * @return JSON string
  */
