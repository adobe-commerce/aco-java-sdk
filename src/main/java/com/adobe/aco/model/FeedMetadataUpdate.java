...
public class FeedMetadataUpdate {
    ...
    public FeedMetadataUpdate searchWeight(java.math.BigDecimal searchWeight) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FeedMetadataUpdate.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in FeedMetadataUpdate is not found in the empty JSON string",
                                FeedMetadataUpdate.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!FeedMetadataUpdate.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `FeedMetadataUpdate` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<FeedMetadataUpdate>() {
                        @Override
                        public void write(JsonWriter out, FeedMetadataUpdate value)
                                throws IOException {
