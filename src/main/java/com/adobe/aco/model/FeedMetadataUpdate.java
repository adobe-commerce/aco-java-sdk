...
public class FeedMetadataUpdate {
  ...
  public enum SearchTypesEnum {
    ...
    public static class Adapter extends TypeAdapter<SearchTypesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SearchTypesEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }
  ...
  **/
  ...
  public FeedMetadataUpdate addVisibleInItem(VisibleInEnum visibleInItem) {
  ...
  **/
  ...
  public FeedMetadataUpdate dataType(DataTypeEnum dataType) {
  ...
  **/
  ...
  public FeedMetadataUpdate searchTypes(List<SearchTypesEnum> searchTypes) {
    this.searchTypes = searchTypes;
    return this;
  }

  public FeedMetadataUpdate addSearchTypesItem(SearchTypesEnum searchTypesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, feedMetadataUpdate.code) &&
        ...
        Objects.equals(this.filterable, feedMetadataUpdate.filterable) &&
        Objects.equals(this.sortable, feedMetadataUpdate.sortable) &&
        Objects.equals(this.searchable, feedMetadataUpdate.searchable) &&
        Objects.equals(this.searchWeight, feedMetadataUpdate.searchWeight) &&
        Objects.equals(this.searchTypes, feedMetadataUpdate.searchTypes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, scope, visibleIn, label, dataType, filterable, sortable, searchable, searchWeight, searchTypes);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to FeedMetadataUpdate
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FeedMetadataUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FeedMetadataUpdate is not found in the empty JSON string", FeedMetadataUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FeedMetadataUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FeedMetadataUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FeedMetadataUpdate.openapiRequiredFields) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("searchTypes") != null && !jsonObj.get("searchTypes").isJsonNull() && !jsonObj.get("searchTypes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `searchTypes` to be an array in the JSON string but got `%s`", jsonObj.get("searchTypes").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FeedMetadataUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FeedMetadataUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FeedMetadataUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FeedMetadataUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<FeedMetadataUpdate>() {
           @Override
           public void write(JsonWriter out, FeedMetadataUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FeedMetadataUpdate read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FeedMetadataUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FeedMetadataUpdate
  * @throws IOException if the JSON string is invalid with respect to FeedMetadataUpdate
  */
  public static FeedMetadataUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FeedMetadataUpdate.class);
  }

 /**
  * Convert an instance of FeedMetadataUpdate to an JSON string
  *
  * @return JSON string
  */
