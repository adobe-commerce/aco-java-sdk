...
public class FeedProductMetadata {
    ...
    public FeedProductMetadata() {}

    public FeedProductMetadata code(String code) {
        this.code = code;
        return this;
    }
    ...
    public FeedProductMetadata source(Source source) {
        this.source = source;
        return this;
    }
    ...
    public FeedProductMetadata visibleIn(List<VisibleInEnum> visibleIn) {
        this.visibleIn = visibleIn;
        return this;
    }

    public FeedProductMetadata addVisibleInItem(VisibleInEnum visibleInItem) {
    ...
    public FeedProductMetadata label(String label) {
        this.label = label;
        return this;
    }
    ...
    public FeedProductMetadata dataType(DataTypeEnum dataType) {
    ...
    public FeedProductMetadata filterable(Boolean filterable) {
    ...
    public FeedProductMetadata sortable(Boolean sortable) {
    ...
    public FeedProductMetadata searchable(Boolean searchable) {
    ...
    public FeedProductMetadata searchWeight(java.math.BigDecimal searchWeight) {
    ...
    public FeedProductMetadata searchTypes(List<SearchTypesEnum> searchTypes) {
        this.searchTypes = searchTypes;
        return this;
    }

    public FeedProductMetadata addSearchTypesItem(SearchTypesEnum searchTypesItem) {
    ...
    public boolean equals(Object o) {
        ...
        FeedProductMetadata feedProductMetadata = (FeedProductMetadata) o;
        return Objects.equals(this.code, feedProductMetadata.code)
                && Objects.equals(this.source, feedProductMetadata.source)
                && Objects.equals(this.visibleIn, feedProductMetadata.visibleIn)
                && Objects.equals(this.label, feedProductMetadata.label)
                && Objects.equals(this.dataType, feedProductMetadata.dataType)
                && Objects.equals(this.filterable, feedProductMetadata.filterable)
                && Objects.equals(this.sortable, feedProductMetadata.sortable)
                && Objects.equals(this.searchable, feedProductMetadata.searchable)
                && Objects.equals(this.searchWeight, feedProductMetadata.searchWeight)
                && Objects.equals(this.searchTypes, feedProductMetadata.searchTypes);
    }
    ...
    public String toString() {
        ...
        sb.append("class FeedProductMetadata {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to FeedProductMetadata
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FeedProductMetadata.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in FeedProductMetadata is not found in the empty JSON string",
                                FeedProductMetadata.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!FeedProductMetadata.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `FeedProductMetadata` properties. JSON: %s",
                                entry.getKey(), jsonElement.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : FeedProductMetadata.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FeedProductMetadata.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'FeedProductMetadata' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<FeedProductMetadata> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(FeedProductMetadata.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<FeedProductMetadata>() {
                        @Override
                        public void write(JsonWriter out, FeedProductMetadata value)
                                throws IOException {
                        ...
                        @Override
                        public FeedProductMetadata read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of FeedProductMetadata given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of FeedProductMetadata
     * @throws IOException if the JSON string is invalid with respect to FeedProductMetadata
     */
    public static FeedProductMetadata fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, FeedProductMetadata.class);
    }

    /**
     * Convert an instance of FeedProductMetadata to an JSON string
     *
     * @return JSON string
     */
